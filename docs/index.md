...
3. **Update your DDNS settings:**
	...
	* 🆕Username:
	  ...
	  __Note: this script matches max 50 zones__ *per_page* param: https://developers.cloudflare.com/api/operations/zones-get
...
4. Enjoy 🍺 and __don't forget to deactivate SSH (step 1) if you don't need it__. Optional, if you're happy with this script you could buy me ☕ or 🍺 here -> [![Sponsor](https://img.shields.io/badge/sponsor-GitHub%20Sponsors-brightgreen)](https://github.com/sponsors/mrikirill)
